...
4- depois que ele escolher // boa viagem (se quiser incremente mais como dito acima)*/
  ...
  if(escolha=="3"){
    ...
    console.log("\n\n NOSSOS PACOTES")
    console.log("1) A vida inteira por apenas 1 das joias do infinito\n2) 3 noites por 100mil bitcoins!\n3) O jogo Valheim custa 37 reais para infinitas horas pela steam!\n")
    escolha = ler ('Digite o número do pacote->  ');
    if(escolha=="1") console.log("Boa viagem e aproveite o resto de sua vida em Valhalla! ");
    if(escolha=="2") console.log("Boa viagem e aproveite suas 3 noites em Valhalla! ");
